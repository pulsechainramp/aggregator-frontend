...
> - The app now rotates through multiple public RPCs automatically, so you stay online even when one provider stalls.
...
| RPC URL priority order | `https://rpc.pulsechain.com`, `https://pulsechain-rpc.publicnode.com`, `https://rpc-pulsechain.g4mm4.io` (we auto-rotate) |
| Chain ID | 369 |
| Currency symbol | PLS |
...
**Troubleshooting**
- RPC slow? Try switching to the next RPC in the list above or use a dedicated private provider.
