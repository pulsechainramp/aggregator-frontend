  ...
  return (
    <div className="relative flex items-center justify-center py-4">
      ...
      <button
        type="button"
        onClick={onSwap}
        className="absolute left-1/2 top-1/2 z-10 flex h-10 w-10 -translate-x-1/2 -translate-y-[65%] items-center justify-center rounded-full border border-border bg-bg-page text-text transition-colors hover:bg-bg-raised focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-focus"
