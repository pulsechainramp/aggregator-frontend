  ...
  return (
    <div>
      <motion.button
        ...
        className={`mt-6 w-full rounded-xl border border-transparent py-4 text-lg font-semibold transition-colors ${
          isDisabled()
            ...
            ? "bg-primary-050 text-primary hover:border-primary hover:bg-primary-050/70"
