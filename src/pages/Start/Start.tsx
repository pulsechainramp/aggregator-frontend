          ...
          {steps.map((step) => (
            ...
            >
              ...
              <Link
                ...
                target="_blank"
                rel="noreferrer"
                className="mt-auto inline-flex items-center justify-center rounded-full border border-primary bg-gradient-to-r from-primary to-primary-600 px-6 py-3 text-base font-semibold text-white shadow-lg transition-all hover:-translate-y-0.5 hover:text-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-focus"
              >
                {step.cta ?? step.title.replace(/^[0-9.\s]+/, "")}
              </Link>
            </article>
          ))}
        </section>
